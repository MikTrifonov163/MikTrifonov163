<%-- 
    Document   : stud
    Created on : 31 мар. 2022 г., 19:57:40
    Author     : Trifonov
--%>
...
<html>
    ...
    <body>
        <form action='subdir.jsp' method="post">
            <jsp:useBean id="sub" class="beans.Stud" scope="page" />
            ...
            <table>
                <c:choose>
                    <c:when test="${empty param.create}">
                        <tr> <th colspan="2" align="center">Редактирование студента </th> </tr> 
                            </c:when>
                            <c:otherwise>
                        <tr> <th colspan="2" align="center">Новый студ</th> </tr> 
                            </c:otherwise>
                        </c:choose>
                <tr>
                ...
                <tr>
                    <td align="right">Возраст(полн лет):</td> 
